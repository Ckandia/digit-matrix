...
const BulkTrades = lazy(() => import('../bulk-trader'));
...
const AppWrapper = observer(() => {
    ...
    const hash = ['dashboard', 'bot_builder', 'chart', 'tutorial', 'bulk_trades'];
    ...
    React.useEffect(() => {
        ...
        const el_bulk = document.getElementById('id-bulk-trades');

        if (!el_dashboard || !el_bulk) return;
        ...
        const observer_bulk = new window.IntersectionObserver(
            ([entry]) => {
        ...
        observer_bulk.observe(el_bulk);

        return () => {
            observer_dashboard.disconnect();
            observer_bulk.disconnect();
        };
    }, []);
                    ...
                    <div>
                        ...
                        <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                            ...
                            >
                                <Suspense
                                    fallback={
                                        <ChunkLoader message={localize('Please wait, loading bulk trades...')} />
                                    }
                                >
                                    <BulkTrades />
                                </Suspense>
